...
namespace API
{
    ...
    public interface IServerC
    {
        ...
        bool CreateMeeting(string coordinatorUser, string coordinatorURL, string topic, uint minAttendees,
        ...
        bool CloseMeeting(string topic, string coordinatorUsername);
