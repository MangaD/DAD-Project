...
- If there are more registered participants than the capacity of the selected meeting room, the system must automatically choose which participants are excluded (using some user-defined criterium).
